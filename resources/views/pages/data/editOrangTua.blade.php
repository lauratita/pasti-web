...
@section('title', 'Form Edit Wali Murid')
@push('style')
    <!-- CSS Libraries -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('orangTua.update', $orangTua->id_ortu) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nik_ortu" value="{{ old('nik_ortu', $orangTua->nik_ortu) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nama_ortu', $orangTua->nama_ortu) }}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                name="email" id="email" value="{{ old('email', $orangTua->email) }}"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control @error('jk_ortu') is-invalid @enderror"
                                                ...
                                                <option value="laki-laki"
                                                    {{ old('jk_ortu', $orangTua->jk_ortu) == 'laki-laki' ? 'selected' : '' }}>
                                                    Laki-laki
                                                </option>
                                                <option value="perempuan"
                                                    {{ old('jk_ortu', $orangTua->jk_ortu) == 'perempuan' ? 'selected' : '' }}>
                                                    Perempuan
                                                </option>
                                            </select>
                                            @error('jk_ortu')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('alamat_ortu') is-invalid @enderror" data-height="150" name="alamat_ortu"
                                            id="alamat_ortu" placeholder="Masukkan Alamat" required>{{ old('alamat_ortu', $orangTua->alamat_ortu) }}</textarea>
                                        @error('alamat_ortu')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
